  ...
  return (
    ...
    >
      <div className="flex flex-col lg:flex-row items-stretch justify-center gap-8">
        {/* Form Container */}
        <div className="w-full max-w-[480px] bg-white rounded-[2rem] shadow-[0_30px_70px_rgba(0,0,0,0.15)] border border-gray-100 overflow-hidden flex flex-col">
          {/* Top Tabs */}
          ...
          <div className="p-6 md:p-8">
            ...
            <div className="flex items-center gap-3 mb-8">
               ...
               <span className="text-[10px] font-black text-blue-950 uppercase tracking-widest whitespace-nowrap">India's Premier Intercity Cabs</span>
               <div className="h-[1px] flex-grow bg-blue-400"></div>
            </div>
            ...
            {/* Mobile Map Integration (Uber-style) */}
