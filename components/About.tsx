        ...
        <div className="flex flex-col lg:flex-row gap-20 items-center">
          ...
          >
            <div className="relative h-[600px] w-full rounded-[4rem] overflow-hidden shadow-3xl z-10">
              <Image src="/banner.png" alt="Amaravathi Fast Car Travels Team" fill className="object-cover" />
          ...
          >
            ...
            <p className="text-slate-500 text-xl font-medium leading-relaxed">
              Founded on the principles of <strong>Speed, Safety, and Sophistication</strong>, Amaravathi Fast Car Travels has grown into South India's premier choice for intercity mobility. We don't just move people; we move memories.
            </p>
