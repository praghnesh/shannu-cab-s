  ...
  return (
    <div className="relative bg-blue-950 pt-20 lg:pt-32 pb-10 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center pt-8 pb-20 lg:pb-24">
          <motion.div
      ...
      <div id="main-booking-form" className="relative z-20 w-full px-4 sm:px-6 lg:px-8 mt-[-100px] lg:mt-[-120px] mb-8 pb-10 max-w-6xl mx-auto">
        <motion.div
