...
export default function FloatingActions() {
  ...
  return (
    <AnimatePresence>
      {/* Mobile Floating WhatsApp - Positioned on Right */}
      {isVisible && (
        <motion.div key="floating-wrapper" className="contents">
          <motion.a 
            ...
            className="md:hidden fixed bottom-32 right-6 z-[2000] bg-green-500 text-white p-4 rounded-full shadow-[0_10px_30px_rgba(34,197,94,0.4)] active:scale-90 border-2 border-white/20"
          >
          ...
          >
            <div className="bg-green-600/90 backdrop-blur-2xl border border-white/20 rounded-[2.5rem] shadow-[0_20px_50px_rgba(0,0,0,0.3)] py-5 px-2 sm:p-2 flex items-center justify-between gap-4">
              ...
              <div className="sm:hidden pl-4 flex flex-col">
                 <span className="text-[10px] font-black text-white/80 uppercase tracking-widest leading-none mb-1">Popular Route</span>
                 <AnimatePresence mode="wait">
                    <motion.span 
                       key={routeIndex}
                       initial={{ opacity: 0 }}
              ...
              <div className="flex gap-2">
                  <a 
                    ...
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="hidden md:flex bg-green-500 text-white p-4 rounded-full hover:bg-green-600 transition-all shadow-lg active:scale-90 items-center gap-2 group px-6 relative"
                  >
