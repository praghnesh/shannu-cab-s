...
const testimonials = [
  {
    ...
    name: "Rajesh Kumar",
    role: "Premium Member",
    content: "Booked an Innova for a family trip to Srisailam. The driver was exceptionally professional, the car was spotless, and the experience was truly VIP. Highly recommend Amaravathi Fast Car Travels!",
    rating: 5
  },
  {
    id: 2,
    ...
    content: "We use Amaravathi Fast Car Travels for all our urgent corporate airport transfers in Hyderabad. They are never late, even for 3 AM flights. The 24/7 support is a lifesaver.",
    rating: 5
  },
  {
    id: 3,
  ...
  },
  {
    ...
    content: "Most reliable cab service for long distances. I've tried many, but Amaravathi Fast Car Travels' punctuality and elite driver behavior are unmatched in South India.",
    rating: 5
  }
];
